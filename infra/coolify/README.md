...
## Pre-deployment Setup (VPS)

Step 1 is required for kickstart-enabled workspaces. Step 2 is optional.

### 1. Initialize Knowledge Base bare repos
...
These repos start empty and are populated by kickstart on first setup.
